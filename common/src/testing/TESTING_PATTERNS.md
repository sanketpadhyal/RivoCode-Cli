...
import { setupDbSpies } from '@rivocode/common/testing/mocks'
...
```typescript
import { createMockLoggerWithCapture } from '@rivocode/common/testing/mocks'
...
```typescript
import { setupAnalyticsMocks } from '@rivocode/common/testing/mocks'
...
```typescript
import { setupCryptoMocks } from '@rivocode/common/testing/mocks'
...
```typescript
import { setupDbSpies } from '@rivocode/common/testing/mocks'
import db from '@rivocode/internal/db'
...
```typescript
import { mockFileContext } from '@rivocode/common/testing/fixtures/agent-runtime'
