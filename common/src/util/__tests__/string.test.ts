...
describe('pluralize', () => {
  ...
  it('should handle tech -o endings', () => {
    ...
    expect(pluralize(2, 'silo')).toBe('2 silos')
  })
  ...
  it('should handle -f/-fe endings', () => {
    ...
    expect(pluralize(2, 'proof')).toBe('2 proofs')
    expect(pluralize(2, 'brief')).toBe('2 briefs')
    expect(pluralize(2, 'chief')).toBe('2 chiefs')
    expect(pluralize(2, 'staff')).toBe('2 staffs')
    expect(pluralize(2, 'serif')).toBe('2 serifs')
    expect(pluralize(2, 'motif')).toBe('2 motifs')
