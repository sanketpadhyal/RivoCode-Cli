...
describe('processBlocks', () => {
  ...
  describe('null filtering', () => {
    test('filters out null returns from handlers', () => {
      ...
      const blocks: ContentBlock[] = [
        createTextBlock('keep'),
        createTextBlock('skip'),
        createTextBlock('keep'),
        createTextBlock('skip'),
      ]
  ...
  describe('index correctness', () => {
    test('maintains correct indices after grouping', () => {
      ...
      const blocks: ContentBlock[] = [
        ...
        createToolBlock('tool-1', 't1'),
        createToolBlock('tool-2', 't2'),
        createToolBlock('tool-3', 't3'),
        createTextBlock('text at 4'),
        createNonImplementorAgent('a1'),
        createNonImplementorAgent('a2'),
      ...
      expect(calls[2].args[1]).toBe(4)
      expect(calls[3].args[1]).toBe(5)
      expect(calls[3].args[2]).toBe(7)
      expect(calls[4].args[1]).toBe(7)
    })
